 ...
 */
public class MysqlUpdateUseTask extends MedicineUseTask
{
    private Alarm alarm;
     ...
     */
    public MysqlUpdateUseTask(Context ctx)
    {
        super(ctx);
    }
    ...
    protected String doInBackground(Alarm... params)
    {
        ...
        try
        {
            URL url = new URL(ctx.getString(R.string.use_update_url, base_url));
            ...
            String data =
                    URLEncoder.encode("useID", "UTF-8") + "=" + URLEncoder.encode(String.valueOf(useID), "UTF-8") + "&" +
