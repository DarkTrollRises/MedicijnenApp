 ...
 */
public class MysqlGcmUnRegisterTask extends BackgroundTask
{
    /**
     * Default constructor
     *
     ...
     */
    public MysqlGcmUnRegisterTask(Context ctx)
    {
        super(ctx);
    }
    ...
    protected String doInBackground(String... params)
    {
        ...
        try
        {
            URL url = new URL(ctx.getString(R.string.unregister_url, base_url));
